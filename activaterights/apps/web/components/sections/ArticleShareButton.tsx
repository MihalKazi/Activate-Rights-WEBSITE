...
/** Figma 34:1062 — share-square; uses native share or copies URL. */
export function ArticleShareButton({ ariaLabel, className }: ArticleShareButtonProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex size-6 shrink-0 items-center justify-center text-[#212121] transition-opacity hover:opacity-70",
        className
      )}
    >
      <svg
