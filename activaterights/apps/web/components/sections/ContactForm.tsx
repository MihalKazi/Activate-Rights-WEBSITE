...
export function ContactForm({ labels, thanksLabel }: ContactFormProps) {
      ...
      <div className="mt-10 flex justify-center md:mt-12">
        <button
          ...
          className={cn(
            ...
            "border border-transparent bg-[#303ccf] px-5 py-5 text-[18px] font-normal uppercase leading-none tracking-wide text-white transition-colors hover:bg-[#2839b5]"
          )}
        >
          {labels.send}
        </button>
